...
DECLARE @ClaimID				VARCHAR(50)		= '[src_clm_id]'
DECLARE @AndWhere				VARCHAR(50)		= 'AND revenue_cd	<> '' '' AND claim_line_id <> '' '''
...
/***
EXEC dbo.x_sp_ProcessLLKeys '[adi].[ClaimAetMA]','01-01-2021','dbo.z_tmp_LLKeyTbl'
