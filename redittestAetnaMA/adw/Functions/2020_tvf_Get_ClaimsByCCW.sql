...
(
		SELECT B1.[SEQ_CLAIM_ID]
		  ...
		  INNER JOIN
			(
				SELECT DISTINCT C3.SEQ_CLAIM_ID, C3.DIAGCODE AS VALUE_CODE, L33.VALUE_CODE_SYSTEM, L33.VALUE_SET_OID
...
Usage: 
SELECT *
FROM [adw].[2020_tvf_Get_ClaimsByCCW] ('01/01/2019','12/31/2019','05/01/2019')
