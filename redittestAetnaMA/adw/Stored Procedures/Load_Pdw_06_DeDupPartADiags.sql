...
AS 
    ...
    */
    ...
    SELECT @InpCnt = COUNT(*) 
	FROM		(	SELECT cd.ClaimAetMAKey AS URN, cd.src_clm_id, src_claim_line_id_2, pri_icd9_dx_cd, adjn_dt,paid_dt_OR_adjn_dt,LoadDate, reversal_cd 
