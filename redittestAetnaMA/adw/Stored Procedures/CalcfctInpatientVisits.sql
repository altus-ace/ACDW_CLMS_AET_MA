...
BEGIN
	...
	SELECT  CONCAT('[adw].[CalcfctInpatientVisits]',@KPIStartDate,'-',@KPIEndDate)
			...
			,b.DISCHARGE_DISPO
			,b.DRG_CODE
			,LEFT(CONCAT(c.PrimaryDiagCode,' ', c.PrimaryDiagDescription),100)
			,b.VENDOR_ID
...
/***
EXEC [adw].[CalcfctInpatientVisits] 16,'07-18-2021','01-01-2019','12-29-2020','05-15-2020'

SELECT *
FROM [adw].[FctInpatientVisits]
where effectiveasofdate = '07-18-2021'


WHERE InstType = 'SNF'

SELECT top 100 * FROM 
	[adw].[2020_tvf_Get_ActiveMembersFull]	('05-15-2020') a
JOIN [adw].[2020_tvf_Get_IPVisits] ('01-01-2020','01-01-2021') b
	ON a.ClientMemberKey = b.SUBSCRIBER_ID
LEFT JOIN [adw].[2020_tvf_Get_PrimarySecondaryDiagCode] ('0','0','01-01-2020') c
	ON b.SUBSCRIBER_ID = c.ClientMemberKey
	AND b.SEQ_CLAIM_ID = c.SeqClaimID
where b.SUBSCRIBER_ID = '9N62AR5JA85' and c.SeqClaimID ='91332630716'
***/
